...
Easy, our kernel code can check CS value saved in Stack by CPU:
...
This repo its just a copy + paste + additions/changes/fixes by David Reguera Garcia aka Dreg from:
